# """
# train_0323_v2.py
# Main training script for SE-ResNet-50 image classification.
...
#     - AutoAugment in dataset (see dataset_v2.py)
# """
...
# def parse_args():
#     parser = argparse.ArgumentParser(description="Train SE-ResNet-50 v2 with MixUp")
...
#     parser.add_argument("--run_name",        type=str,   default="se_resnet50_v2")
